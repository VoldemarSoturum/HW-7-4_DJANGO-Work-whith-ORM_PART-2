    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('tag', 'article'), name='unique_tag_per_article'), models.UniqueConstraint(condition=models.Q(('is_main', True)), fields=('article',), name='unique_main_scope_per_article')],
            },
        ),
    ]
